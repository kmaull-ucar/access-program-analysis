...
1. _How much do the original ACCESS data, Crossref and OpenAlex datasets overlap?_

   The original data has more than 2100 DOIs (or DOI-like things),
   of which **2121** are in Crossref.  OpenAlex contains
   metadata for **2097** of the Crossref DOIs, so they **differ by 24 DOIs**, representing
   a **98.9% overlap**.
